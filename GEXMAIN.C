...
void process();
extern int bounds(int, int, int, int);
extern int item(int, int);
extern int modulo(int);
extern int prices(int, int,int, int,int, int,int, int,int, int,int, int,int, int,int, int,int, int,int, int,int, int,int, int);
extern int select(int, int, int);
extern int set(int, int, int, int);
